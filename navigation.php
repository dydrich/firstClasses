<nav id="navigation">
	...
	<div class="nav_div" style="float: right; margin-right: 50px; position: relative; top: 20px; text-align: right">Area segreteria::<span id="navlabel"><?php echo $navigation_label ?></span></div>
